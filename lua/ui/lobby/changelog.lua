...
changelog = {
    ...
    },
    {
        ...
        description = {
            ...
            '- Fixed selen radar going off when powerstalling',
            '- Fixed T2 fighter/bomber slowing down on move order when there is land/naval target on the way',
            '- Fixed the nuke trajectory leading to nuke on mountain and ending too short on big maps',
            '- Fixed wrong civilian blueprints',
            '- Fixed sera arty not shooting at its target',
            '- Fixed UEF Cattlecruiser leaving no mass behind',
            ...
            '- Fixed omen and exodus not retargeting ',
            '- Fixed arty having issue targeting unit on higher ground',
            '',
            '**Other**',
